...
const KAKAO_MAP_KEY = process.env.NEXT_PUBLIC_KAKAO_JAVASCRIPT_KEY ?? process.env.DB_KAKAO_API_KEY;

const URL = `https://dapi.kakao.com/v2/maps/sdk.js?appkey=${KAKAO_MAP_KEY}&libraries=services,clusterer,drawing&autoload=false`;
